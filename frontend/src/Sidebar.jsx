...
>
  ...
  ></span>
  <div className="border-4 mb-4 border-white rounded-full overflow-hidden">
    <img src={userData.data.avatar_url} alt="User Avatar" className="transition-all duration-300 w-28 h-28 object-cover" />
  </div>
</div>



       <div className="text-lg font-semibold text-black dark:text-white mb-2">Name: {userData.data?.login}</div>
...
<div className="transition-all duration-300 flex flex-col mt-8">
