  ...
  return (
    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <nav className="flex items-center justify-between h-16 lg:h-20">
            ...
            <button href="#" title="" className="items-center justify-center hidden px-4 py-3 ml-10 text-base font-semibold text-white transition-all duration-200 bg-blue-600 border border-transparent rounded-md lg:inline-flex hover:bg-blue-700 focus:bg-blue-700" role="button" onClick={handleLogout}>Logout</button>
        </nav>
        ...
        <nav className="pt-4 pb-6 bg-white border border-gray-200 rounded-md shadow-md lg:hidden">
            ...
            <div className="px-6 mt-6">
                <a href="#" title="" className="inline-flex justify-center px-4 py-3 text-base font-semibold text-white transition-all duration-200 bg-blue-600 border border-transparent rounded-md tems-center hover:bg-blue-700 focus:bg-blue-700" role="button" onClick={handleLogout}>Logout</a>
            </div>
        </nav>
    </div>
</header>
