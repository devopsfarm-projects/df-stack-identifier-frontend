...
const Login = () => {
    ...
    return (
        <>
            <div className="relative py-16 bg-black text-white flex items-center justify-center">
                <div className="container flex flex-col md:flex-row mx-auto px-6 text-gray-500 md:px-12 xl:px-40">
                        ...
                        <div className="rounded-xl bg-black shadow-xl">
                            <div className="p-6 sm:p-16">
                                ...
                                <div className="mt-16 grid space-y-4">
                                    <button className="group h-12 px-6 border-2 border-white rounded-full transition duration-300 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100" onClick={handleLogin}>
                                        <div className="relative flex items-center space-x-4 justify-center">
                                            ...
                                            <span className="block w-max font-semibold tracking-wide text-white text-sm transition duration-300 group-hover:text-blue-300 sm:text-base">Continue with Github</span>
                                        </div>
                                    </button>
                                </div>
                            </div>
