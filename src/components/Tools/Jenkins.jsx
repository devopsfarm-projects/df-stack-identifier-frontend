import Jenkinsimg from "../Learning-Paths/images/Jenkins.png";
...
function Jenkins() {
  return (
    <>
      ...
      <div className="w-full relative flex flex-col dark:bg-gray-800 items-center">
              ...
              <section className="py-10 relative sm:py-16 lg:py-24 lg:text-gray-100 text-gray-900">
                ...
                <div className="text-gray-600 mt-10 border border-spacing-8 p-4">
                  ...
                  <ul className="list-disc ml-4">
                    <li>Learn what is Jenkins and how it works in depth</li>
                    <li>Learn Continuous Integration and Continuous Deployment</li>
                    <li>Learn how to integrate Jenkins with Docker, Ansible, AWS, GIT, Email, Maven and more!</li>
