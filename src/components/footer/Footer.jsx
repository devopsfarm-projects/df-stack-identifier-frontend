function Footer() {
  return (
    <footer className="transition-all duration-300 flex  shadow-[0_32px_50px_rgba(8,_112,_184,_0.7)] dark:shadow-[0_5px_20px_rgba(240,_46,_170,_0.7)] flex-col space-y-10 justify-center  bg-white text-black dark:bg-clip-bg  dark:bg-transparent dark:bg-logo-gradient dark:text-white py-12" style={{ borderBottom: '1px solid #666' }}>
